<?php
    ...
    <?php endif; ?>
        ...
        transition:all 0.15s">
                    ...
                    <a href="/tool/index.php?slug=<?= e($t['slug']) ?>" class="btn-secondary">Review</a>
                    <a href="/go.php?slug=<?= e($t['slug']) ?>" class="btn-primary" target="_blank" rel="noopener noreferrer">Visit Site →</a>
                </div>
            </div>